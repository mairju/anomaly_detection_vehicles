...
class CustomTestDataset(Dataset):
    ...
    def __init__(self, root_dir, resize_shape=(224, 224*2)):
        self.root_dir = root_dir
        self.resize_shape = resize_shape
    ...
    def __getitem__(self, idx):
        ...
        if dir_name == 'good':
            # No mask for good images
            image, mask = self.transform_image(img_path, None)
            has_anomaly = np.array([0], dtype=np.float32)
        else:
            # Mask path for abnormal images
            mask_path = os.path.join(self.root_dir, 'ground_truth', file_name)
...
class CustomTrainDataset(Dataset):
    ...
    def __init__(self, image_dir, anomaly_source_dir, resize_shape=(224, 224*2)):
...
# TODO: Add Poisson, CutPaste, FPI
    ...
    def transform_image(self, image_path):
        ...
        return image, anomaly_mask, has_anomaly
    ...
    def __getitem__(self, idx):
        ...
        image, anomaly_mask, has_anomaly = self.transform_image(image_path)
